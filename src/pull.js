...
var getMostRecentTransition = function (fromTime) {
...
var getTransitionsFromTime = function (fromTime) {
  var deferred = q.defer();
  var queryParams = {fromTime: fromTime.toISOString(), pageSize: 1000};
  var items = [];

  getAllPages(queryParams, true, items).then(function (items) {
    deferred.resolve(_.groupBy(items, 'epc'));
  });
...
module.exports = {
  getMostRecentTransition: getMostRecentTransition,
  getTransitionsFromTime : getTransitionsFromTime
};
